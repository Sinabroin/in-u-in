      ...
      <div className="container mx-auto px-4">
        ...
        <Tabs defaultValue="free" className="max-w-4xl mx-auto">
          <TabsList className="grid w-full grid-cols-3 mb-8">
            {["free", "subscription", "consulting"].map((tab) => (
              <TabsTrigger
                key={tab}
                value={tab}
                className="data-[state=active]:bg-[#2A4ECD] data-[state=active]:text-white transition-colors"
              >
                {tab === "free" ? "무료" : tab === "subscription" ? "구독제" : "인터뷰 컨설팅"}
              </TabsTrigger>
            ))}
          </TabsList>
              ...
              <CardContent className="p-6">
                ...
                <ul className="space-y-4 mb-6">
                  <li className="flex items-center">
                    <CheckCircle className="w-5 h-5 text-[#2A4ECD] mr-2" />
                    정성적 인터뷰 관련 전자책 증정
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="w-5 h-5 text-[#2A4ECD] mr-2" />
          ...
          <TabsContent value="subscription">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <div className="text-3xl font-bold mb-6">50,000원<span className="text-lg font-normal">/월</span></div>
